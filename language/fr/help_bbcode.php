...
$help = array(
	...
	array(
		...
		1 => 'Les pièces jointes peuvent dès à présent être transférées dans les messages en utilisant le nouveau BBCode <strong>[attachment=][/attachment]</strong>, si cette fonctionnalité a été activée par l’administrateur du compte et si vous en avez les permissions appropriées. Pour transférer des pièces jointes en ligne, un onglet à cet effet est affiché en bas de l’écran de rédaction.',
	),
	array(
		0 => '--',
		1 => 'Divers',
	...
	array(
		...
		1 => 'Si vous êtes un administrateur de ce compte et que vous en avez les permissions appropriées, vous pouvez ajouter davantage de BBCodes dans la section « Personnaliser les BBCodes ».',
	),
);

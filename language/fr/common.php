...
$lang = array_merge($lang, array(
	...
	'ACP_SHORT'                                          => 'PCA',
	'ACTIVE'                                             => 'actif',
	'ACTIVE_ERROR'                                       => 'Le nom d’utilisateur que vous avez spécifié est actuellement inactif. Si vous rencontrez des difficultés lors de l’activation de votre compte, veuillez contacter un administrateur du compte.',
	...
	'AND'                                                => 'et',
	'ARE_WATCHING_FORUM'                                 => 'Vous êtes à présent abonné(e) à ce Compte de Suivi. Vous recevrez une notification lorsqu’un nouveau sujet sera publié dans ce dernier.',
	...
	'BOARD_BAN_PERM'         => 'Vous avez été <strong>définitivement</strong> banni(e) de ce compte.<br /><br />Pour plus d’informations, veuillez contacter l’%2$sadministrateur du compte%3$s.',
	'BOARD_BAN_REASON'       => 'Raison du bannissement : <strong>%s</strong>',
	'BOARD_BAN_TIME'         => 'Vous avez été banni(e) de ce compte jusqu’au <strong>%1$s</strong>.<br /><br />Pour plus d’informations, veuillez contacter l’%2$sadministrateur du compte%3$s.',
	'BOARD_DISABLE'          => 'Le compte est actuellement indisponible.',
	'BOARD_DISABLED'         => 'Le compte est actuellement désactivé.',
	'BOARD_UNAVAILABLE'      => 'Le compte est actuellement indisponible. Veuillez réessayer ultérieurement.',
	'BROWSING_FORUM'         => 'Utilisateurs parcourant ce compte : %1$s',
	'BROWSING_FORUM_GUESTS'  => array(
		1 => 'Utilisateurs parcourant ce compte : %2$s et %1$d invité',
		2 => 'Utilisateurs parcourant ce compte : %2$s et %1$d invités',
	),
	'BUTTON_EDIT'         => 'Éditer',
	...
	'CHANGING_PREFERENCES' => 'Modifie les préférences du compte',
	...
	'COOKIES_DELETED'       => 'Tous les cookies du compte ont été supprimés.',
	...
	'DELETE_COOKIES'   => 'Supprimer tous les cookies du compte',
	...
	'FORUM'                => 'Compte',
	'FORUMS'               => 'Comptes',
	'FORUMS_MARKED'        => 'Les comptes ont été marqués comme lus.',
	'FORUM_CAT'            => 'Catégorie du compte',
	'FORUM_INDEX'          => 'Accueil du compte',
	'FORUM_LINK'           => 'Compte-lien',
	'FORUM_LOCATION'       => 'Emplacement du compte',
	'FORUM_LOCKED'         => 'Compte verrouillé',
	'FORUM_RULES'          => 'Règles du compte',
	'FORUM_RULES_LINK'     => 'Veuillez cliquer ici afin de consulter les règles du compte',
	'FROM'                 => 'de',
	...
	'FTP_FSOCK_ROOT_PATH'         => 'Chemin vers le compte',
	...
	'FTP_ROOT_PATH'         => 'Chemin vers le compte',
	...
	'LOGIN_ERROR_PASSWORD'                     => 'Vous avez spécifié un mot de passe incorrect. Veuillez vérifier votre mot de passe et réessayer. Si ce problème persiste, veuillez contacter l’%sadministrateur du compte%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'             => 'Il n’a pas été possible de convertir votre mot de passe lors de la mise à jour de ce logiciel de compte de discussions. Veuillez %sdemander un nouveau mot de passe%s. Si ce problème persiste, veuillez contacter l’%sadministrateur du compte%s.',
	'LOGIN_ERROR_USERNAME'                     => 'Vous avez spécifié un nom d’utilisateur incorrect. Veuillez vérifier votre nom d’utilisateur et réessayer. Si ce problème persiste, veuillez contacter l’%sadministrateur du compte%s.',
	'LOGIN_FORUM'                              => 'Vous devez saisir le mot de passe de ce compte afin de pouvoir consulter ou publier des sujets et des messages.',
	'LOGIN_INFO'                               => 'Vous devez être inscrit(e) avant de pouvoir vous connecter. L’inscription est rapide et vous offre de nombreux avantages. Par exemple, l’administrateur du compte peut accorder des fonctionnalités supplémentaires aux utilisateurs inscrits. Avant de vous inscrire, assurez-vous d’avoir pris connaissance de nos conditions d’utilisation et de notre politique de confidentialité. Veuillez également consulter attentivement toutes les règles du compte lors de votre navigation.',
	'LOGIN_VIEWFORUM'                          => 'Vous devez être inscrit(e) et connecté(e) afin de pouvoir consulter ce compte.',
	'LOGIN_EXPLAIN_EDIT'                       => 'Vous devez être inscrit(e) et connecté(e) afin de pouvoir éditer les messages de ce compte.',
	...
	'MARK_FORUMS_READ'    => 'Marquer les comptes comme lus',
	'MARK_READ'           => 'Marquer comme lu',
	'MARK_SUBFORUMS_READ' => 'Marquer les sous-comptes comme lus',
	'MB'                  => 'Mo',
	'MIB'                 => 'Mio',
	...
	'NOT_WATCHING_FORUM'       => 'Vous n’êtes à présent plus abonné(e) à ce compte. Vous ne recevrez plus de notification lorsqu’un nouveau sujet sera publié dans ce dernier.',
	...
	'NOTIFICATION_FORUM'                  => '<em>Compte :</em> %1$s',
	...
	'NOTIFY_ADMIN'              => 'Veuillez contacter l’administrateur du compte.',
	'NOTIFY_ADMIN_EMAIL'        => 'Veuillez contacter l’administrateur du compte : <a href="mailto:%1$s">%1$s</a>',
	...
	'NO_FORUM'                  => 'Le compte que vous souhaitez consulter n’existe pas.',
	'NO_FORUMS'                 => 'Aucun compte.',
	...
	'NO_FEED_ENABLED'           => 'Les flux ne sont pas disponibles sur ce compte.',
	...
	'NO_TOPIC_FORUM'            => 'Le compte ou le sujet que vous souhaitez consulter est introuvable.',
	'NO_TOPICS'                 => 'Aucun sujet n’a été publié dans ce compte.',
	'NO_TOPICS_TIME_FRAME'      => 'Aucun sujet n’a été publié dans ce compte lors de cette période.',
	...
	'POSTS_UNAPPROVED_FORUM'  => 'Au moins un message de ce compte n’a pas été approuvé.',
	'POST_BY_AUTHOR'          => 'par',
	...
	'READING_LINK'            => 'Visite le compte-lien %s',
	...
	'REMOVE'                   => 'Supprimer',
	'REMOVE_INSTALL'           => 'Veuillez supprimer, déplacer ou renommer le répertoire « install » de votre serveur afin d’utiliser votre compte. Tant que ce répertoire est présent, seul le panneau de contrôle d’administration sera accessible.',
	'REPLIES'                  => 'Réponses',
	...
	'RETURN_FORUM'             => '%sRevenir au dernier compte visité%s',
	'RETURN_PAGE'              => '%sRevenir à la page précédente%s',
	'RETURN_TOPIC'             => '%sRevenir au dernier sujet visité%s',
	'RETURN_TO'                => 'Revenir vers « %s »',
	'RETURN_TO_INDEX'          => 'Revenir à l’index du compte',
	'FEED'                     => 'Flux',
	'FEED_NEWS'                => 'Nouveautés',
	'FEED_TOPICS_ACTIVE'       => 'Sujets actifs',
	'FEED_TOPICS_NEW'          => 'Nouveaux sujets',
	'RULES_ATTACH_CAN'         => 'Vous <strong>pouvez</strong> transférer des pièces jointes dans ce compte',
	'RULES_ATTACH_CANNOT'      => 'Vous <strong>ne pouvez pas</strong> transférer de pièces jointes dans ce compte',
	'RULES_DELETE_CAN'         => 'Vous <strong>pouvez</strong> supprimer vos messages dans ce compte',
	'RULES_DELETE_CANNOT'      => 'Vous <strong>ne pouvez pas</strong> supprimer vos messages dans ce compte',
	'RULES_DOWNLOAD_CAN'       => 'Vous <strong>pouvez</strong> télécharger des pièces jointes dans ce compte',
	'RULES_DOWNLOAD_CANNOT'    => 'Vous <strong>ne pouvez pas</strong> télécharger de pièces jointes dans ce compte',
	'RULES_EDIT_CAN'           => 'Vous <strong>pouvez</strong> éditer vos messages dans ce compte',
	'RULES_EDIT_CANNOT'        => 'Vous <strong>ne pouvez pas</strong> éditer vos messages dans ce compte',
	'RULES_LOCK_CAN'           => 'Vous <strong>pouvez</strong> verrouiller vos sujets dans ce compte',
	'RULES_LOCK_CANNOT'        => 'Vous <strong>ne pouvez pas</strong> verrouiller vos sujets dans ce compte',
	'RULES_POST_CAN'           => 'Vous <strong>pouvez</strong> publier de nouveaux sujets dans ce compte',
	'RULES_POST_CANNOT'        => 'Vous <strong>ne pouvez pas</strong> publier de nouveaux sujets dans ce compte',
	'RULES_REPLY_CAN'          => 'Vous <strong>pouvez</strong> répondre aux sujets dans ce compte',
	'RULES_REPLY_CANNOT'       => 'Vous <strong>ne pouvez pas</strong> répondre aux sujets dans ce compte',
	'RULES_VOTE_CAN'           => 'Vous <strong>pouvez</strong> voter aux sondages dans ce compte',
	'RULES_VOTE_CANNOT'        => 'Vous <strong>ne pouvez pas</strong> voter aux sondages dans ce compte',
	...
	'SEARCHING_FORUMS'         => 'Recherche dans les comptes',
	...
	'SELECT_DESTINATION_FORUM' => 'Veuillez sélectionner un compte de destination',
	'SELECT_FORUM'             => 'Sélectionner un compte',
	...
	'SORRY_AUTH_READ'          => 'Vous ne pouvez pas consulter ce compte.',
	...
	'SQL_ERROR_OCCURRED'       => 'Une erreur SQL est survenue lors du chargement de la page. Si ce problème persiste, veuillez contacter l’%sadministrateur du compte%s.',
	'STATISTICS'               => 'Statistiques',
	'START_WATCHING_FORUM'     => 'S’abonner au compte',
	'START_WATCHING_TOPIC'     => 'S’abonner au sujet',
	'STOP_WATCHING_FORUM'      => 'Se désabonner du compte',
	'STOP_WATCHING_TOPIC'      => 'Se désabonner du sujet',
	'STRING_LIST_MULTI'        => '%1$s, et %2$s',
	'STRING_LIST_SIMPLE'       => '%1$s et %2$s',
	'SUBFORUM'                 => 'Sous-compte',
	'SUBFORUMS'                => 'Sous-comptes',
	'SUBJECT'                  => 'Sujet',
	'SUBMIT'                   => 'Envoyer',
	...
	'TOPIC'              => 'Sujet',
	'TOPICS'             => 'Sujets',
	'TOPICS_UNAPPROVED'  => 'Au moins un des sujets de ce compte n’a pas été approuvé.',
	...
	'UNWATCH_FORUM_CONFIRM'   => 'Êtes-vous sûr(e) de vouloir vous désabonner de ce compte ?',
	'UNWATCH_FORUM_DETAILED'  => 'Êtes-vous sûr(e) de vouloir vous désabonner du compte « %s » ?',
	...
	'UNWATCHED_FORUMS'        => 'Vous n’êtes à présent plus abonné(e) aux comptes sélectionnés.',
	...
	'USER_CANNOT_READ'        => 'Vous ne pouvez pas consulter les messages de ce compte.',
	'USER_POSTS'              => array(
		1 => '%d message',
		2 => '%d messages',
	),
	...
	'USER_NEW_PERMISSION_DISALLOWED' => 'Vous ne pouvez pas utiliser cette fonctionnalité. Vous devez vous inscrire et participer activement aux discussions du compte.',
	...
	'WATCH_FORUM_CONFIRM'  => 'Êtes-vous sûr(e) de vouloir vous abonner à ce compte ?',
	'WATCH_FORUM_DETAILED' => 'Êtes-vous sûr(e) de vouloir vous abonner au compte « %s » ?',
	...
	'WELCOME_SUBJECT'      => 'Bienvenue sur les comptes de %s',

...
$lang = array_merge($lang, array(
	...
	'FORUM_PERMISSIONS' => 'Permissions du compte',

	'ICON_ANNOUNCEMENT' => 'Annonce',
	'ICON_STICKY'       => 'Note',

	'LOGIN_NOTIFY_FORUM' => 'Vous avez reçu une notification concernant un message de ce compte. Veuillez vous connecter afin de pouvoir le consulter.',
	...
	'NO_READ_ACCESS'         => 'Vous ne pouvez pas consulter les sujets de ce compte.',
	'NO_UNREAD_POSTS_HOT'    => 'Aucun message non lu [ Populaire ]',
	'NO_UNREAD_POSTS_LOCKED' => 'Aucun message non lu [ Verrouillé ]',

	'POST_FORUM_LOCKED' => 'Le compte est verrouillé',

	'TOPICS_MARKED' => 'Les sujets de ce compte ont été marqués comme lus.',

	'UNREAD_POSTS_HOT'    => 'Messages non lus [ Populaires ]',
	'UNREAD_POSTS_LOCKED' => 'Messages non lus [ Verrouillés ]',

	'VIEW_FORUM'        => 'Consulter le compte',
